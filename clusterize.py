...
ANTI_TOPICS = [
    ...
    "IPO, фандрейзинг и оценки AI-компаний: IPO технологических компаний, раунды инвестиций, оценки стоимости, SPAC, поглощения на публичном рынке — когда история про деньги, а не про технологии",
    "Корпоративная борьба и внутренние конфликты AI-компаний: смена CEO, увольнения, борьба за власть в совете директоров, судебные споры между партнёрами, корпоративные интриги",
    "Кадровые перестановки и увольнения в AI-компаниях: массовые layoffs, сокращения, реструктуризация — без связи с конкретным AI-продуктом или технологией",
    "Суды и регуляторные разбирательства вокруг AI-компаний: антимонопольные дела, иски, штрафы, расследования SEC или других регуляторов — когда фокус на нарушении закона, а не на технологии",
]
